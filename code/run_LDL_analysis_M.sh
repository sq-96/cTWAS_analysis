...
do 
	...
	OUTDIR="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/LDL_M/"$WEIGHT
	job_name="LDL_"$WEIGHT
	job_out="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/code/LDL_M_out/"$job_name".out"
	job_err="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/code/LDL_M_out/"$job_name".err"

...
do 
	...
	WEIGHT_FILE="/project2/compbio/predictdb/mashr_models/mashr_Whole_Blood.db;/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/mashr_sqtl/sqtl/mashr/mashr_Whole_Blood_Splicing.db;/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/mqtl/GTEx_Whole_Blood_Methylation.db"
	...
	OUTDIR="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/WhiteBlood_E_S_M/"$WEIGHT
	job_name="WhiteBlood_"$WEIGHT
	job_out="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/code/WhiteBlood_E_S_M_out/"$job_name".out"
	job_err="/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/code/WhiteBlood_E_S_M_out/"$job_name".err"

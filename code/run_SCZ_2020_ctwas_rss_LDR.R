...
if (file.exists(z_snp_outfile)){
  ...
  z_snp <- fread("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/PGC3_SCZ_wave3_public.v2.tsv",fill=TRUE)
  z_snp <- na.omit(z_snp)
  z_snp$Z <- log(z_snp$OR)/z_snp$SE
  z_snp$SS <- z_snp$Nca+z_snp$Nco

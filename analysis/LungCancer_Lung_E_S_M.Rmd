---
title: "LungCancer - Lung Traits Jointly"
author: "Sheng Qian"
date: "2023-2-1"
...
params:
  analysis_id: "LungCancer_Lung"
  trait_id: "LungCancer_E_S_M"
  weight: "Lung"
---
...
ctwas_gene_M_res <- ctwas_gene_res[ctwas_gene_res$group=="M",]

sqlite <- RSQLite::dbDriver("SQLite")
db = RSQLite::dbConnect(sqlite, "/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/Predictive_Models/Prostate_E.db")
query <- function(...) RSQLite::dbGetQuery(db, ...)
gene_info <- query("select gene, genename from extra")
RSQLite::dbDisconnect(db)
ctwas_gene_E_res$genename <- gene_info[sapply(ctwas_gene_E_res$gene_id, match, gene_info$gene),"genename"]

load("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/Predictive_Models/Prostate_Splicing_mapping.RData")
ctwas_gene_S_res$genename <- intron_info[sapply(ctwas_gene_S_res$gene_id, match, intron_info$gene), "genename"]

sqlite <- RSQLite::dbDriver("SQLite")
db = RSQLite::dbConnect(sqlite, "/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/Predictive_Models/Prostate_M.db")
query <- function(...) RSQLite::dbGetQuery(db, ...)
gene_info <- query("select gene, genename from extra")
RSQLite::dbDisconnect(db)

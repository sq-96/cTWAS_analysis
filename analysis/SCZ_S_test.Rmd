...
#ctwas_gene_res <- ctwas_gene_res[!is.na(ctwas_gene_res$genename),]

ctwas_gene_res$genename <- paste0(ctwas_gene_res$id," (",ctwas_gene_res$genename,")")
...
```{r}
a <- locus_plot_final_pub(region_tag="6_26", return_table=T,
                      focus=NULL,
                      label_genes=NULL,
                      rerun_ctwas=F,
                      rerun_load_only=F,

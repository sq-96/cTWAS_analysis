...
for(i in 1:length(groups)){
  g <- groups[i]
  points(a$pos[a$type=="gene" & a$group==g], a$PVALUE[a$type == "gene" & a$group==g], pch = 21+i, bg = colorsall[1], cex = 2)
  points(a$pos[a$type=="gene" & a$r2max > r2cut & a$group==g], a$PVALUE[a$type == "gene"  & a$r2max > r2cut & a$group==g], pch = 21+i, bg = "purple", cex = 2)
  points(a$pos[a$type=="gene" & a$focus == 1 & a$group==g], a$PVALUE[a$type == "gene" & a$focus == 1 & a$group==g], pch = 21+i, bg = "salmon", cex = 2)
}
  
if (legend_panel=="TWAS"){
    x_pos <- ifelse(legend_side=="right", max(a$pos)-0.2*(max(a$pos)-min(a$pos)), min(a$pos))
    legend(x_pos, y= 1 ,c(groups,"SNP","Lead TWAS Gene", "R2 > 0.4", "R2 <= 0.4"), pch = c(22:(21+length(group)),21,19,19,19), col = c("black","black","black", "black", "salmon", "purple", colorsall[1]), cex=0.7, title.adj = 0)
}
...
for(i in 1:length(groups)){
  g <- groups[i]
  points(a$pos[a$type=="gene" & a$group==g], a$susie_pip[a$type == "gene" & a$group==g], pch = 21+i, bg = colorsall[1], cex = 2)
  points(a$pos[a$type=="gene" & a$r2max > r2cut & a$group==g], a$susie_pip[a$type == "gene"  & a$r2max > r2cut & a$group==g], pch = 21+i, bg = "purple", cex = 2)
  points(a$pos[a$type=="gene" & a$focus == 1 & a$group==g], a$susie_pip[a$type == "gene" & a$focus == 1 & a$group==g], pch = 21+i, bg = "salmon", cex = 2)
}

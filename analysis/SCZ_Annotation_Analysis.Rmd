...
```{r,echo=FALSE}
library(reactable)
SCZ_annotation <- summary_table("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/SCZ/")
reactable(SCZ_annotation)

for(i in 2:15){
  print(paste0("Number of genes in ",colnames(SCZ_annotation)[i],": ",sum(SCZ_annotation[,i])))
}
```
...
```{r,echo=FALSE}
library(reactable)
SCZ_annotation <- summary_table("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/SCZ_2014_EUR/")
reactable(SCZ_annotation,resizable = TRUE)
...
```{r,echo=FALSE}
library(reactable)
SCZ_annotation <- summary_table("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/SCZ_2018/")
reactable(SCZ_annotation,resizable = TRUE)
...
```{r,echo=FALSE}
library(reactable)
SCZ_2020_annotation <- summary_table("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/SCZ_2020/")
reactable(SCZ_2020_annotation,resizable = TRUE)

for(i in 2:15){
  print(paste0("Number of genes in ",colnames(SCZ_2020_annotation)[i],": ",sum(SCZ_2020_annotation[,i])))
}
```
